...
export const HUB_PAGES_DATA: Record<string, HubPageData> = {
  'Kreativitas': {
    pageTitle: 'Metode Belajar',
    pageDescription: 'Buat rencana belajar Anda, dan tingkatkan pemahaman serta efisiensi belajar dengan berbagai metode dan teknik teruji.',
    sections: [{
      title: 'Metode Belajar & Produktivitas',
      description: 'Tingkatkan pemahaman dan efisiensi belajar Anda dengan berbagai metode dan teknik teruji.',
      cards: [
  ...
  'Interaktif': {
    pageTitle: 'Diskusi & Berlatih',
    pageDescription: 'Bagian ini akan melatih Anda untuk tetap berpikiran kritis. Simulasikan berbagai peran untuk memperdalam pemahaman dan kemampuan argumentasi Anda.',
    sections: [{
      title: 'Diskusi & Simulasi',
      ...
      cards: [
        ...
        { title: 'Konsultasi Belajar ABM-UT', description: 'Dapatkan bimbingan dan wawasan dari ABM-UT yang berperan sebagai mentor berpengalaman di bidang studi Anda.', targetView: 'Konsultasi Belajar ABM-UT' },
  ...
  'Alat Bantu': {
    pageTitle: 'Produktivitas & Penulisan',
    pageDescription: 'Bagian ini akan membantu Anda untuk meningkatkan kualitas dan efisiensi tulisan akademis.',
    sections: [{
      title: 'Produktivitas & Penulisan',
      description: 'Alat bantu untuk meningkatkan kualitas dan efisiensi tulisan akademis Anda.',
      cards: [
  ...
  'Simulasi': {
    pageTitle: 'Analisis & Persiapan',
    pageDescription: 'Bagian ini akan membantu Anda untuk menganalisis informasi, mensintesis ide-ide kompleks, dan bersiap untuk ujian.',
    sections: [{
      title: 'Analisis & Persiapan',
      description: 'Alat untuk menganalisis informasi, mensintesis ide-ide kompleks, dan bersiap untuk ujian.',
      cards: [
        ...
        { title: 'Prediksi Nilai UAS', description: 'Kalkulator untuk memprediksi skor UAS yang dibutuhkan & mendapatkan saran belajar yang dipersonalisasi dari ABM-UT.', targetView: 'Prediksi Nilai UAS' },
      ]
    }]
  },
  'Tutorial Online': {
  ...
  'Tracking': {
    pageTitle: 'Pelacakan Aktivitas',
    pageDescription: 'Lacak riwayat belajar interaktif dan semua pengingat tenggat waktu yang telah Anda buat.',
    sections: [{
      title: 'Manajemen & Pelacakan',
      description: 'Akses riwayat sesi dan pengingat Anda.',
      cards: [
  ...
  'Pengaturan': {
    pageTitle: 'Pengaturan & Kustomisasi',
    pageDescription: 'Atur preferensi aplikasi Anda, kelola kunci API, dan reset data jika diperlukan.',
    sections: [{
  ...
  'Informasi': {
    pageTitle: 'Bantuan & Informasi Aplikasi',
    pageDescription: 'Informasi tentang aplikasi, daftar pertanyaan yang sering diajukan, hingga detail pembaruan aplikasi.',
    sections: [{
...
if (!isApiKeyFeatureEnabled) {
  ...
  const pengaturanCards = HUB_PAGES_DATA['Pengaturan'].sections[0].cards;
  HUB_PAGES_DATA['Pengaturan'].sections[0].cards = pengaturanCards.filter(
    card => card.targetView !== 'Integrasi API'
  );

  // Filter out API-related cards from Informasi
  const informasiCards = HUB_PAGES_DATA['Informasi'].sections[0].cards;
  HUB_PAGES_DATA['Informasi'].sections[0].cards = informasiCards.filter(
