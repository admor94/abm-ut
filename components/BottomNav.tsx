...
const BottomNavItem: React.FC<{
    ...
    const colorClassMap: Partial<Record<AppView, string>> = {
      ...
      'Belajar & Latihan': 'text-ut-green',
      'Produktivitas & Riset': 'text-ut-yellow',
      'Riwayat & Pelacakan': 'text-ut-blue-light',
...
const OtherMenuPopup: React.FC<{
    ...
    isLocked: boolean;
    usedInviteCode: string | null;
}> = ({ onClose, setActiveView, isLocked, usedInviteCode }) => {
            ...
            <div className="fixed bottom-20 left-4 right-4 bg-slate-800/80 backdrop-blur-md rounded-xl shadow-lg z-50 p-2 border border-slate-700 animate-slide-up">
                <ul className="space-y-1">
                    ...
                    <li>
                     ...
                     <li>
                        <button 
                            onClick={() => !pengaturanIsDisabled && handleSelect('Pengaturan & Bantuan')}
                        ...
                        >
                           ...
                           <span className="font-display font-semibold">Pengaturan & Bantuan</span>
                        </button>
                    </li>
                </ul>
            </div>
...
export const BottomNav: React.FC<BottomNavProps> = ({ activeView, setActiveView, isLocked, usedInviteCode }) => {
    ...
    const isLainnyaActive = ['Tutorial Online', 'Seputar UT', 'Pengaturan & Bantuan', 'Eksperimental'].includes(activeParent);
    ...
    return (
        <div>
            ...
            {isOtherMenuOpen && <OtherMenuPopup onClose={() => setIsOtherMenuOpen(false)} setActiveView={setActiveView} isLocked={isLocked} usedInviteCode={usedInviteCode} />}
        </div>
    );
};
